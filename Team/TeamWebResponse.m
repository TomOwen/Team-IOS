...
#import "TeamWebResponse.h"

@interface TeamWebResponse ()

@end

@implementation TeamWebResponse
...
- (void)viewDidLoad
{
    ...
    NSString *serverURL = [[NSString alloc]initWithFormat:@"http://%@:%@@%@/teamresponse.php?teamid=%@&patient_id=%@&user_name=%@",dbuser,dbpassword,dbserver,teamid,patientID,myuser];
    //NSLog(@"url=%@",serverURL);
