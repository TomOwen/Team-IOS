...
#import "StudyPieDisplay.h"

@interface StudyPieDisplay ()

@end

@implementation StudyPieDisplay
...
- (void)viewDidLoad
{
    ...
    NSString *serverURL = [[NSString alloc]initWithFormat:@"http://%@:%@@%@/graphstudypie.php?teamid=%@&study_id=%@&user_name=%@",dbuser,dbpassword,dbserver,teamid,study_id,myuser];
    //NSLog(@"url=%@",serverURL);
